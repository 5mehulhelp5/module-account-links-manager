...
namespace ETechFlow\AccountLinksManager\Test\Unit\Model;
...
class LicenseValidatorTest extends TestCase
{
    ...
    public function testExplicitRevokeFlagWinsOverEverything(): void
    {
        ...
        $this->setConfig([
            LicenseValidator::XML_PATH_LICENSE_KEY => 'SP-live-abc123',
            LicenseValidator::XML_PATH_PORTAL_API_URL => self::PORTAL,
            'etechflow_accountlinks/license/revoked' => '1',
        ]);
        $this->setCacheMiss();
    ...
    public function testForgedKeyAndAttackerControlledConfigCannotBypass(): void
    {
        ...
        $this->setConfig([
            ...
            'etechflow_accountlinks/license/issued_key'     => 'SP-i-made-this-up',
            'etechflow_accountlinks/license/issued_domain'  => 'totally-pirated-store.com',
            'etechflow_accountlinks/license/stripe_session' => 'cs_fake_123',
            'etechflow_accountlinks/license/issued_at'      => (string) time(),
        ]);
    ...
    public function testGraceFromPriorSuccessKeepsStorefrontLiveWhilePortalUnreachable(): void
    {
        ...
        $graceKey = 'etf_alm_lic_grace_' . md5($host . ':' . $key);
    ...
    public function testGraceDoesNotApplyToADifferentHost(): void
    {
        ...
        $goodGraceKey = 'etf_alm_lic_grace_' . md5('shop.example.com:SP-live-abc123');
        $this->cache->method('load')->willReturnCallback(
