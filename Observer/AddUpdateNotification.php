...
namespace ETechFlow\AccountLinksManager\Observer;
 ...
 * of Account Links Manager is published to the eTechFlow private Composer repo.
 * Fires when the admin opens the module's admin area. Re-added if dismissed;
 * never duplicated while an active entry for the same version exists. Fail-safe.
 */
class AddUpdateNotification implements ObserverInterface
{
    private const PACKAGE     = 'etechflow/module-account-links-manager';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-account-links-manager.json';
    private const CACHE_KEY   = 'etechflow_alm_latest_version';
    private const CACHE_TTL   = 21600;
    private const LABEL       = 'Account Links Manager';
