...
class CreateSession extends Action
{
    ...
    public function execute(): ResultInterface
    {
        ...
        try {
            ...
            $successUrl     = $frontendBase . '/etechflow-alm/license/callback?session_id={CHECKOUT_SESSION_ID}';
            $cancelUrl      = (string) $this->getUrl('etechflow_accountlinks/license/index');
            $adminReturnUrl = (string) $this->getUrl('etechflow_accountlinks/license/success');
    ...
    private function callStripe(
        ...
        $p = [
            ...
            'metadata[plan]'             => $plan,
            'metadata[module]'           => 'account-links-manager',
